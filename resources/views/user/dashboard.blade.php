...
<style>
    ...
    .quick-link { padding:12px 20px; background:#fff; border-radius:10px; text-decoration:none; color:#111; font-size:14px; font-weight:500; box-shadow:0 1px 4px rgba(0,0,0,.08); display:flex; align-items:center; gap:8px; }
...
<div class="dash-wrap">
    ...
    @empty
    <p style="color:#aaa;text-align:center;padding:40px;">No orders yet. <a href="{{ route('books.index') }}" style="color:#e8c97e;">Start shopping!</a></p>
    @endforelse
